...
if __name__ =='__main__':
	try:
		...
		pose_subscriber = rospy.Subscriber('/rmp440le/odom',Odometry, posCallback)

		velocity_publisher=rospy.Publisher('/rmp440le/base/vel_cmd', TwistStamped, queue_size=50)
		time.sleep(1)

		# move(velocity_publisher,2,20,True)
		# rotate(velocity_publisher,90,360,1)
		go_to_goal(velocity_publisher,20.0,20.0)
